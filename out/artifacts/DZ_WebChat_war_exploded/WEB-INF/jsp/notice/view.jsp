...
<body>
<a href="${pageContext.request.contextPath}/board/list?type=notice">이전</a><br/>
...
<button id="like">좋아유 <span id="likeCount">${board.likeCnt}</span></button>
<button id="dislike">싫어유 <span id="dislikeCount">${board.disLikeCnt}</span></button>
<script>
